...
const Stats = () => {
    ...
    return (
        <div>
                ...
                <div data-aos="fade-up" className="px-4 pb-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pb-20">
                    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                        ...
                        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight sm:text-4xl md:mx-auto">
                            ...
                            People Reconnect with Lost <span className='text-purple-400'>Belongings</span>
                        </h2>
                        <p className="text-base md:text-lg">
                            From misplaced phones to precious documents — we’ve made it easier to report, discover, and recover what matters most.
                        </p>
                    </div>
                    ...
                    <div className="relative w-full p-px mx-auto mb-4 overflow-hidden transition-shadow duration-300 border rounded lg:mb-8 lg:max-w-4xl group hover:shadow-xl">
                        ...
                        <div className="relative flex flex-col items-center h-full py-10 duration-300 bg-white rounded-sm transition-color sm:items-stretch sm:flex-row">
                            <div className="px-12 py-8 text-center">
                                <h6 className="text-4xl font-bold text-deep-purple-accent-400 sm:text-5xl text-purple-400">
                                    89%
                                </h6>
                                <p className="text-center text-black">
                                    Users successfully reunited with their lost items through our platform.
                                </p>
                            </div>
                            ...
                            <div className="px-12 py-8 text-center">
                                ...
                                <p className="text-center text-black">
                                    Lost and found reports submitted from schools, offices, and public places.
                                </p>
                            </div>
                        </div>
                    </div>

                    <p className="mx-auto mb-4 sm:text-center lg:max-w-2xl lg:mb-6 md:px-16">
                        Join a growing community that believes every lost item deserves a second chance.
                    </p>
                </div>
